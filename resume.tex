...
\begin{itemize}
      ...
      %       \zh{ 同时参与 SRE 部门公有云运维管理系统镜像发布系统相关的前端研发工作，React.js 进行前端页面设计与实现}
      \item \en{Responsible for physical cloud business related back-end research and development as well as maintenance, using node.js, JavaScript language for API, physical cloud operation and maintenance management system development and maintenance. Standardised and optimised the process of making physical cloud images, installation and adaptation.}
            \zh{负责物理云业务相关的后端研发以及运维工作，使用 node.js 进行 API、物理云运维管理系统的开发与维护，规范并优化了物理云镜像制作、装机适配流程，保证了业务稳定。}
...
\en{\datedsubsection{\textbf{\href{http://cdn.peroperogames.com/}{PeroPeroGames}}, Beijing, China}{01/2021 -- Present}}
\zh{\datedsubsection{\textbf{\href{http://cdn.peroperogames.com/}{广州呸喽呸喽科技有限公司 (PeroPeroGames)}}}{2021/01 -- 至今}}
\en{\role{Technical Department}{Game Server Engineer}}
\zh{\role{技术部}{游戏服务端工程师}}
\begin{itemize}
      \item \en{Participated in in-house PeroDB data center development}
            \zh{参与公司内部PeroDB数据中心后端研发工作，主要使用irirs、postgresql进行后端开发}
